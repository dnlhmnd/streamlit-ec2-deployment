...
# Filter 'df0' DataFrame by "Pizza Evaluation" with "Standard" values
filtered_df0 = st.session_state.df0[st.session_state.df0["Pizza Evaluation"] == "Standard"]
...
st.data_editor(
    ...
    column_config={
        ...
        "Pizza Classification": st.column_config.SelectboxColumn(
            ...
            width="medium",
            required=True,  # Set to True if a value is required
        ),
